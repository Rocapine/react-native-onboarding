  ...
  children: [
    {
      ...
      props: {
        content:
          trigger === 'flexGrow'
            ? 'flexGrow: 1 + onPress — the pre-fix workaround, always rendered'
            : `flex: 1 + ${trigger}`,
        fontSize: 12,
          ...
          children: [
            {
              id: 'root',
              type: 'YStack' as const,
              props: { flex: 1, gap: 18, padding: 24 },
              children: [
                {
                  id: 'title',
                  type: 'Text' as const,
                ...
                },
                {
                  ...
                  props: {
                    content:
                      'Each yellow band is the height its row reserves. All four rows must show a band as tall as their cards.',
                    fontSize: 14,
                    color: '#8A8A8E',
                  },
                },
