...
Omitted fields keep the previous look: height `12`, a fully-rounded track (radius = half the height), `16` horizontal padding, `24` bottom padding, `16` gap, a `1 / 5 / 1` three-column row, and a `24`px back chevron in `theme.colors.text.primary`.
