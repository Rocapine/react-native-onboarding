...
both an onboarding step's `purchase` action and a standalone paywall's.
...
(see [Page Types](./page-types.mdx#composablescreen)) — same elements, same
...
[Page Types](./page-types.mdx#composablescreen) for both.
