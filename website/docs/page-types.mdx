...
| `keyboardType` | `"default" \| "email-address" \| "numeric" \| "phone-pad" \| "number-pad" \| "decimal-pad"` | Defaults to `"default"` |
...
```json
// Input that captures the user's name
{
  "id": "name-input",
  "type": "Input",
  "props": {
...
// Text that interpolates it — updates live as the user types
{
  "id": "greeting",
  "type": "Text",
  "props": {
